import{f as d,h as _,j as h,ag as p,c as m,ah as u,l as n,m as i,ai as t,aj as o,y as s,F as f,ak as g,al as v,am as x,an as y,ao as b,ap as N,n as k,aq as w,_ as P}from"./nav-17a90c75.js";import{N as S}from"./NoteViewer-1051d102.js";import{u as V}from"./index-69be57b6.js";const j={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},C={class:"text-lg"},D={class:"font-bold flex gap-2"},H={class:"opacity-50"},z=t("div",{class:"flex-auto"},null,-1),F={key:0,class:"border-gray-400/50 mb-8"},M=d({__name:"PresenterPrint",setup(q){_(h),p(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
